...
| Task 05c local instructions | Vendored Dietrich Gebert's Ponytail v4.10.0 skill and MIT license byte for byte. The manifest now resolves all four seats. Two real local builds produced identical 111-file bundles, and four isolated fixture agents read their Law, charter, Ponytail, and assigned skill and answered seat-rule conflicts consistently. See [TASK-05C-FIXTURE.md](TASK-05C-FIXTURE.md); no Paperclip or Hermes instruction delivery is claimed |
